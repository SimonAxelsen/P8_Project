...
public class LlmService : MonoBehaviour
{
    ...
    void OnMessage(byte[] bytes)
    {
        ...
        if (baseMsg.type == "llm" || baseMsg.type == "llm_parsed")
        {
            ...
            if (msg == null || string.IsNullOrWhiteSpace(msg.npc))
                return;
...
{
    public int score;
    public string strengthsParagraph;
    public string weaknessesParagraph;
}

[System.Serializable]
class EvaluationResultMsg
{
    public string type;
    public string participantId;
    public string model;
    public int transcriptTurns;
    public InterviewEvaluation evaluation;
    public string result;
}

public class InterviewEvaluationEvent
{
    public string participantId;
    public string model;
    public int transcriptTurns;
